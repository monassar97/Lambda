...
public class MyList <E>{
	public static void main(String[] args) {
		...
		System.out.println("Even : "+queue.filter(x->(Integer) x%2==0));
		System.out.println("Odd : "+queue.filter(x->(Integer) x%2!=0));
	...
	public <U,T> HashMap<U, MyList<E>> groupingBy(Function<E, U> key){
