...
public class Cache {
	...
	public synchronized void addValueToDS(int value) {
		if(c.size()>=capacity) {
			...
			c.add(new DS(value));
			System.out.println("value "+value+" added after deleted");
		}
		else {
			c.add(new DS(value));
	...
	public synchronized static void add(int val) throws InterruptedException {
	...
	public synchronized static void get(int val) throws InterruptedException {
